    ...
    <motion.div
      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        <motion.div
          ...
          transition={{ duration: 0.86, delay: 0.2 }}
          viewport={{ once: true }}
        ...
        <motion.div
          ...
          <div className="flex gap-2 text-sm">
            <input
              ...
              className="w-full p-3 text-sm outline-none rounded dark:text-gray-200 bg-transparent border border-gray-50-300 darK:border-gray-500"
            />
      ...
      <motion.div
        ...
        <p>Copyright &copy; 2025 GreatStack - All Right Reserved.</p>
